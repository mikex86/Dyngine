...
LLGL::SamplerAddressMode GetLLGLAddressMode(DAsset::TextureAddressMode addressMode) {
    switch (addressMode) {
        case DAsset::TextureAddressMode::REPEAT:
            return LLGL::SamplerAddressMode::Repeat;
        case DAsset::TextureAddressMode::MIRROR:
            return LLGL::SamplerAddressMode::Mirror;
        case DAsset::TextureAddressMode::CLAMP:
            return LLGL::SamplerAddressMode::Clamp;
        case DAsset::TextureAddressMode::BORDER:
            return LLGL::SamplerAddressMode::Border;
        case DAsset::TextureAddressMode::MIRROR_ONCE:
...
LLGL::SamplerFilter GetLLGLFilter(DAsset::TextureFilter filter) {
    switch (filter) {
        case DAsset::TextureFilter::NEAREST:
            return LLGL::SamplerFilter::Nearest;
        case DAsset::TextureFilter::LINEAR:
...
LLGL::Sampler *CreateOptionalSampler(const std::shared_ptr<LLGL::RenderSystem> &renderSystem,
    ...
    auto texture = optionalTexture.value();
    auto llglAddressMode = GetLLGLAddressMode(texture->addressMode);
    auto llglFilter = GetLLGLFilter(texture->textureFilter);

    LLGL::SamplerDescriptor samplerDescriptor{
            .addressModeU = llglAddressMode,
            .addressModeV = llglAddressMode,
            .addressModeW = llglAddressMode,
            .minFilter = llglFilter,
            .magFilter = llglFilter,
            .mipMapFilter = llglFilter
    };
        ...
        std::vector<LLGL::VertexFormat> vertexFormats{};
        {
            ...
            for (const auto &entry: meshPart.attributeBufferViews) {
                ...
                // Create vertex format
                {
                    ...
                    vertexFormat.SetSlot(attributeIndex);
